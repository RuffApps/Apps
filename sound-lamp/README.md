...
1.[Sound Sensor(Model:SOUND-01)](https://rap.ruff.io/devices/KY-016)

2.[Relay Module(Model:RELAY-1C)](https://rap.ruff.io/devices/SW-1801P)
...
添加声音传感器，运行如下命令：
    ...
    rap device add sound

然后输入外设型号，比如：SOUND-01
